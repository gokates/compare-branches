...
#Clone the git repo under "compare-branches" dir
echo ""
[ -d "./compare-branches/repo" ] && echo "The existence of repo dir implies Git repo is ready." || git clone https://github.com/gokates/compare-branches.git compare-branches/repo
...
if [ "${DEBUG_MODE}" == 'local' ]; then
    ...
    echo ""
    echo "=== Notes:"
    echo "    Examples: http://0.0.0.0/git/scan?an=pro   http://0.0.0.0/git/scan?sb=featureBranch&since=18&an=Provungshu"
