"""
Here we go with the app logic that compares two branches to find out commit differences...
"""
...
def clone(localDir):
    ...
    run("clone", "https://github.com/gokates/compare-branches.git", localRepoDir)
